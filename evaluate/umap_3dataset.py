...
def plot_umap(embedding, save_path='data/matrix2.png'):
    """
    ...
    plt.scatter(embedding[:790, 0], embedding[:790, 1], c='red', cmap='Spectral', s=5,label='Originset')
    plt.scatter(embedding[790:810, 0], embedding[790:810, 1], c='blue', cmap='Spectral', s=5,label='Validset1')
    plt.scatter(embedding[810:852, 0], embedding[810:852, 1], c='green', cmap='Spectral', s=5,label='Validset2')
